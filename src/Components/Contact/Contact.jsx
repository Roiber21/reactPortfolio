...
const Contact = () => {
    ...
    return (
        ...
        <main className='container_contact' >
            ...
            <h5 className='form_span'>fill out the form to contact you</h5>
                ...
                <textarea required className='input_contact' placeholder="How can I help you?" maxlength="200" name="field" id="field" cols="30" rows="3"></textarea>
